    ...
    return (
        <main style={{ maxWidth: '900px', margin: '0 auto', padding: '4rem 1.5rem' }}>
            ...
            <div style={{ textAlign: 'center', marginBottom: '4rem' }}>
                <div style={{ marginBottom: '1rem', display: 'inline-block', padding: '4px 14px', background: 'rgba(251,146,60,0.1)', border: '1px solid rgba(251,146,60,0.3)', borderRadius: '20px', fontSize: '12px', color: '#fb923c', fontFamily: 'monospace', letterSpacing: '0.1em' }}>
                ...
                <h1 style={{ fontSize: 'clamp(2rem, 6vw, 3.5rem)', fontWeight: 700, fontFamily: 'Courier New, monospace', color: '#e2e8f0', lineHeight: 1.15, margin: '0.75rem 0' }}>
                    Your OPNet Identity
                    <br />
                    <span style={{ color: '#fb923c', textShadow: '0 0 30px rgba(251,146,60,0.4)' }}>On-Chain</span>
                </h1>
                ...
                <button
                    ...
                    style={{
                        ...
                        border: '1px solid #fb923c', borderRadius: '10px',
                        color: '#fff', fontFamily: 'Courier New, monospace',
                        fontSize: '14px', fontWeight: 700, cursor: 'pointer',
                        letterSpacing: '0.1em', boxShadow: '0 0 30px rgba(251,146,60,0.3)',
                    }}
                >
                    Connect OP_WALLET
                </button>
            ...
            <div>
                <div style={{ textAlign: 'center', marginBottom: '1.5rem' }}>
                    <span style={{ fontFamily: 'monospace', fontSize: '12px', color: '#6b7280', letterSpacing: '0.12em' }}>
            ...
            <div style={{ marginTop: '4rem', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '16px' }}>
                {[
                    { title: 'Soulbound NFTs',       desc: 'Badges are non-transferable. Your achievements cannot be bought or sold.',      color: '#fb923c' },
                    ...
                    <div key={f.title} style={{ background: '#0f1117', border: '1px solid rgba(255,255,255,0.05)', borderRadius: '12px', padding: '20px' }}>
                        <div style={{ fontFamily: 'monospace', fontWeight: 700, fontSize: '14px', color: f.color, marginBottom: '8px' }}>{f.title}</div>
                        <div style={{ fontFamily: 'monospace', fontSize: '12px', color: '#6b7280', lineHeight: 1.6 }}>{f.desc}</div>
                    </div>
                ))}
            </div>
        </main>
